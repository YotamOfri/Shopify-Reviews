...
export default function Footer() {
  return (
    <footer className="text-slate-400 duration-300 ease-out body-font bg-[#060912] border-t border-slate-500">
        ...
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-slate-400 duration-300 ease-out hover:text-slate-500 cursor-pointer">
                  First Link
                </a>
              </li>
              <li>
      ...
      <div>
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row border-t border-slate-500">
